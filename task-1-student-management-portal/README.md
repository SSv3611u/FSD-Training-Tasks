...
Bootstrap 5 project for Task 1 in the FSD lab practice sheet.
...
The project uses Bootstrap CDN links, so an internet connection is required for Bootstrap styles and scripts.
